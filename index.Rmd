...
In collaboration with [Who Targets Me](https://whotargets.me/), we monitored over 900 Dutch political advertisers during the 2023 Provinciale Statenverkiezingen (Senate elections) to better understand how campaigns use different targeting methods made available by Meta. To do this, we used data from the [Meta Ad Library](https://www.facebook.com/ads/library/), using the new 'Audience' data which gives some detail on how pages target their ads.
