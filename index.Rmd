...
color_dat <- tibble(
  colors = c("#00b13d", "#80c31c", "#0a2cca", "#008067", "#770100", "#ff0000", "#6f2421", "#02a6e9", "#92107d", "#04d3d4", "#242b57", "#66cdaa", "#242b57", "#006b28", "#012758", "#ea5b0b", "#582c83"),
  party = c("D66", "GroenLinks", "VVD", "CDA", "SP", "PvdA", "FvD", "ChristenUnie", "50PLUS", "Alliantie", "BVNL", "DENK", "Ja21", "PvdD", "PVV", "SGP", "Volt Nederland"))
...
nlsb %>% 
    ...
    drop_na(party) %>% 
    group_by(create_date, party) %>% 
    summarize(spend  = sum(spend)) %>% 
    ggplot(aes(create_date, spend, color = party)) +
    geom_line() +
    scale_color_parties() +
    facet_wrap(~party) +
    ggthemes::theme_hc() +
